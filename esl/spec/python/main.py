...
filename_park_pos = os.path.join(cwd, 'CarParkPos1')
with open(filename_park_pos, 'rb') as f:
    posList = pickle.load(f)

width, height = 90, 40   #bilo je 48
...
def checkParkingSpace(imgPro):
    ...
    for pos in posList:
        ...
        if count < limit:     # bilo je 950 bez median, 530 ako hoces bez dilate i median, 770 sve redovno
            color = (0, 255, 0)
            thickness = 2
            spaceCounter += 1
        else:
